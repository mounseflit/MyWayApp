...
function rot13Encrypt(inputString) {
  ...
  var originalString = "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";
  
  var encryptedString = rot13Encrypt(originalString);
  console.log("Encrypted String: " + encryptedString);
  
  var decryptedString = rot13Decrypt("fx-eosupm2E4OAC74ysmQxeG3OyoxSW8IB7C8Avh5Vc5ashJ5IO");
